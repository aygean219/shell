...
//-process A will receive numbers ending with values >5,will substract one from the received numbers and will
//send them back to the parent that will display the number on the screen
//-process B will receive numbers ending with value <=5,will send them back to the parent the result of dividing
// the numbers to 2 the parent will display the received result on sreen
